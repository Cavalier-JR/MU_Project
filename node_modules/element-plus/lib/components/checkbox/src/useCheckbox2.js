...
var index$1 = require('../../../hooks/use-common-props/index2.js');
...
const useCheckboxStatus = (props, slots, { model }) => {
  ...
  const size = index$1.useSize(checkboxGroup == null ? void 0 : checkboxGroup.checkboxGroupSize, { prop: true });
  ...
  const checkboxSize = index$1.useSize(vue.computed(() => {
    var _a;
